...
const Register = () => {
 ...
 if (skipRecaptcha) {
 try {
 await authService.register({ nombre: name, email, password, recaptchaToken: 'localhost-bypass' });
 ...
 <div className="min-h-screen flex items-center justify-center bg-dark-950 relative overflow-hidden p-4">
   ...
   <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
     <div className="absolute top-[-15%] right-[-8%] w-[45%] h-[45%] rounded-full bg-brand-600/10 blur-[140px]" />
     <div className="absolute bottom-[-15%] left-[-8%] w-[45%] h-[45%] rounded-full bg-earth-600/8 blur-[140px]" />
   ...
   <div className="w-full max-w-sm relative z-10 animate-fade-up">
     ...
     <div className="text-center mb-8">        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white border border-dark-400/40 shadow-lg shadow-black/20 mb-3 ring-1 ring-brand-500/20">
       ...
       <h1 className="text-xl font-bold text-white tracking-tight">Crear una Cuenta</h1>
       <p className="mt-1.5 text-sm text-gray-500">Únete a GreenField para administrar tu granja</p>
     </div>
     ...
     <div className="rounded-2xl border border-dark-400/40 bg-dark-800/60 backdrop-blur-xl p-6 shadow-xl">
       ...
       <form onSubmit={handleRegister} className="space-y-4">
         {/* Name */}
         <div>
           <label htmlFor="reg-name" className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">
             Nombre Completo
           </label>
           <input
             id="reg-name"
         ...
         {/* Email */}
         <div>
           <label htmlFor="reg-email" className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">
             Correo Electrónico
           </label>
           <input
             id="reg-email"
         ...
         {/* Password */}
         <div>
           <label htmlFor="reg-password" className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">
             Contraseña
           </label>
         ...
         {/* Confirm Password */}
         <div>
           <label htmlFor="reg-confirm" className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">
