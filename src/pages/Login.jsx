    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Credenciales no coinciden o hubo un problema al conectar",
      );
    } finally {
      loading.hideLoading();
    }
      ...
      <div className="w-full max-w-lg relative z-10 animate-fade-up">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-2 max-w-sm text-base text-gray-400">
            Ingresa tus credenciales para continuar y gestionar tu hacienda.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-dark-400/40 bg-dark-800/55 p-8 shadow-2xl backdrop-blur-2xl">
          {registered && (
            <div className="mb-6 flex items-center gap-3 rounded-2xl border border-brand-700/35 bg-brand-950/40 px-5 py-4 text-sm text-brand-300 animate-slide-up">
              <svg
